        ...
        <div id="page-body" class="d-flex">
            <div id="sidebar" class="bg-white">
                <ul id="sidebar-menu">
                    ...
                    <li class="nav-link {{ $module_active == 'building' ? 'active' : ''  }}">
                        <a href="{{ url('admin/building/list') }}">
                            <div class="nav-link-icon d-inline-flex">
                                <i class="far fa-folder"></i>
                            </div>
                            Tòa nhà
                        ...
                        <i class="arrow fas fa-angle-right"></i>
                        <ul class="sub-menu">
                            <li><a href="{{ url('admin/building/add') }}">Thêm mới</a></li>
                            <li><a href="{{ url('admin/building/list') }}">Danh sách</a></li>
                        </ul>
                    </li>
                    <li class="nav-link">
