                            ...
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    @if (request()->input('status') == 'trash')
                                        <td>
                                            <a href="{{ route('user.restore', $user->id ) }}" class="btn btn-success btn-sm rounded-0 text-white" type="button" data-toggle="tooltip" data-placement="top" title="Khôi phục"><i class="fas fa-trash-restore-alt"></i></a>
                                            <a href="{{ route('user.permanentlydelete', $user->id) }}" onclick="return confirm('Bạn có chắc chắn xóa bản ghi này không?')" class="btn btn-danger btn-sm rounded-0 text-white" type="button" data-toggle="tooltip" data-placement="top" title="Xóa vĩnh viễn"><i class="fa fa-trash"></i></a>
                                        </td>
                                    @else
                                        <td>
